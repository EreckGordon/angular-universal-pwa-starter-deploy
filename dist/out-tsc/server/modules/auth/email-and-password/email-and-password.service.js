...
var EmailAndPasswordService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, this.securityService.createSessionToken({
                                roles: user.roles,
                                id: user.id,
                                loginProvider: 'emailAndPassword',
                            })];
    ...
    EmailAndPasswordService.prototype.removeEmailAndPasswordProvider = function (provider) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.emailAndPasswordProviderRepository.remove(provider)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    EmailAndPasswordService.prototype.updateEmailAndPasswordProvider = function (provider) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
